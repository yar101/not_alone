...
Route::get('/api/help-center', [HelpController::class, 'index'])->name('help.data');
...
Route::middleware(['auth', 'not_banned'])->group(function () {
    ...
    Route::middleware('verified')->group(function () {
        ...
        Route::post('/profile/trait-suggestions', [UserProfileController::class, 'storeTraitSuggestion'])->middleware('throttle:10,1')->name('profile.trait-suggestions.store');
        Route::post('/profile/interest-suggestions', [UserProfileController::class, 'storeInterestSuggestion'])->middleware('throttle:10,1')->name('profile.interest-suggestions.store');
        ...
        Route::patch('/profile/services/categories/{category}/description', [UserProfileController::class, 'updateCategoryDescription'])->name('profile.services.category.description');
    ...
    Route::post('/api/wallet/deposit', [WalletController::class, 'deposit'])->middleware('throttle:30,1')->name('wallet.deposit');
    Route::post('/api/wallet/withdraw', [WalletController::class, 'withdraw'])->middleware('throttle:30,1')->name('wallet.withdraw');
});
