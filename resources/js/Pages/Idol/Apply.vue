...
.btn-secondary:hover { background: rgba(190, 145, 255, 0.07); border-color: rgba(190, 145, 255, 0.65); }
...
.quiz-segment--done { background: rgba(190, 145, 255, 0.55); }
.quiz-segment--active { background: #BE91FF; }
...
.option-row:hover:not(:disabled) {
    ...
    border-color: rgba(190, 145, 255, 0.28);
    color: rgba(255,255,255,0.92);
}
.option-row:disabled { cursor: default; }

.option-row--selected {
    background: rgba(190, 145, 255, 0.1) !important;
    border-color: rgba(190, 145, 255, 0.5) !important;
    color: #fff !important;
}
.option-row--correct {
...
.dropzone {
    width: 100%;
    min-height: 150px;
    border: 1px dashed rgba(190, 145, 255, 0.3);
    border-radius: 3px;
    display: flex;
    flex-direction: column;
    align-items: center;
...
.dropzone:hover { border-color: rgba(190, 145, 255, 0.55); background: rgba(190, 145, 255, 0.04); }
.dropzone--has-file { border-style: solid; border-color: rgba(190, 145, 255, 0.4); }
